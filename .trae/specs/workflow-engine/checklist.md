...
- [ ] Task 21: 样式基础设施 — `theme.py`、QSS 加载入口正常，应用启动无崩溃
- [ ] Task 21: 基础样式 — 全局背景色 #1E1E1E、滚动条、按钮、输入框样式统一
- [ ] Task 22: 主窗口 — 工具栏按钮有图标+文字、状态栏样式
- [ ] Task 23: 节点面板 — 分类网格卡片、悬停效果、左侧颜色边框
- [ ] Task 24: 画布背景 — 网格点阵正常显示
- [ ] Task 24: 贝塞尔曲线 — 连线变为光滑曲线
- [ ] Task 25: 节点样式 — 圆角卡片、类别颜色、选中发光
- [ ] Task 25: 呼吸动画 — 运行时节点脉冲效果
- [ ] Task 26: 属性面板 — 统一配色 + 左侧琥珀色装饰条
- [ ] Task 26: 日志面板 — 统一配色 + 左侧琥珀色装饰条
- [ ] Task 27: 右键菜单 — 深色上下文菜单样式
- [ ] Task 27: 整合 — 应用正常启动，所有面板正常显示，无崩溃
